        ...
        <li class="nav-item">
            <a class="nav-link ${activePage == 'myQueue' ? 'active' : ''}"
               href="${pageContext.request.contextPath}/doctor/queue/list">
                <i class="fa-solid fa-calendar-check me-2"></i> Manage queue
            </a>
        </li>
        ...
        <li class="nav-item">
            <a class="nav-link ${activePage == 'manageMedicalRecord' ? 'active' : ''}"
               href="${pageContext.request.contextPath}/doctor/medical-record/list">
                <i class="fa-solid fa-file-medical me-2"></i> Manage medical record
            </a>
        </li>
...
<!--
        ...
        <c:if test="${hasCertView}">
            <li class="nav-item">
                <a class="nav-link ${activePage == 'myCertification' ? 'active' : ''}"
                   href="${pageContext.request.contextPath}/doctor/certification/my">
            ...
            <li class="nav-item">
                <a class="nav-link ${activePage == 'manageAppointment' ? 'active' : ''}"
                   href="${pageContext.request.contextPath}/doctor/appointment/list">
                    <i class="fa-solid fa-gauge me-2"></i> Manage appointment
                </a>
            </li>
        </c:if>
        ...
        <li class="nav-item">
            <a class="nav-link ${activePage == 'manageServiceOrder' ? 'active' : ''}"
               href="${pageContext.request.contextPath}/doctor/service-order/list">
                <i class="fa-solid fa-vials me-2"></i> Manage service order
            </a>
        </li>
