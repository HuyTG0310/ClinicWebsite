...
<body>
    <div class="container">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <form method="post" action="${pageContext.request.contextPath}/AddPatient" class="needs-validation" novalidate>
                        ...
                        <div>
                            ...
                            <div class="input-group">
                                ...
                                <input type="tel" class="form-control" id="phone" name="phone"
                                       ...
                                       oninput="validatePhone(this)" onblur="checkPhoneExists(this)">
                            </div>
                    ...
                    <div class="mb-4">
                        ...
                        <div class="input-group">
                            ...
                            <textarea class="form-control" id="medicalHistory" name="medicalHistory"
                                      placeholder="Enter medical history (optional)" rows="2"></textarea>
                        </div>
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control" id="allergy" name="allergy"
                                   placeholder="Enter allergy information (optional)">
                        </div>
                    </div>
    ...
    <script>
        ...
        function checkPhoneExists(input) {
            ...
            phoneExistsCheckTimer = setTimeout(() => {
                ...
                fetch('${pageContext.request.contextPath}/api/checkPhoneExists?phone=' + encodeURIComponent(phone))
