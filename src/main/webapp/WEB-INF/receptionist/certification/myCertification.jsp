...
<html>
    ...
    <head>
        <meta charset="UTF-8">
        <title>My Certifications - Receptionist</title>
    ...
    <body>
            ...
            <div class="table-card">
                <div class="d-flex justify-content-between align-items-center mb-4">
                    <h3>
                        ...
                        My Certifications (Receptionist)
                    </h3>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <form id="editCertForm" method="post" enctype="multipart/form-data"
                          action="${pageContext.request.contextPath}/receptionist/certification/edit">
        ...
        <div class="modal fade" id="deleteModal" tabindex="-1">
            <div class="modal-dialog">
                <div class="modal-content">
                    <form method="post" action="${pageContext.request.contextPath}/receptionist/certification/delete">
