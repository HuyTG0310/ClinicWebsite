        ...
        <div class="card bg-success text-white shadow border-0 h-100">
            <div class="card-body p-4 d-flex align-items-center">
                ...
                <div>
                    ...
                    <h3 class="mb-0 fw-bolder">
                        <fmt:formatNumber value="${totalCash}" pattern="#,###"/> VNĐ
                    </h3>
                </div>
            </div>
        </div>
        ...
        <div class="card bg-info text-white shadow border-0 h-100">
            <div class="card-body p-4 d-flex align-items-center">
                ...
                <div>
                    ...
                    <h3 class="mb-0 fw-bolder">
                        <fmt:formatNumber value="${totalBanking}" pattern="#,###"/> VNĐ
                    </h3>
                </div>
            </div>
        </div>
            ...
            <table class="table table-hover align-middle mb-0">
                ...
                <thead class="table-light">
                    ...
                    <tr>
                        ...
                        <th>
                            <i class="fas fa-clock me-2 text-primary"></i>Collection Time
                        </th>
                        ...
                        <th>
                            <i class="fas fa-notes-medical me-2 text-primary"></i>Service
                        </th>
                        ...
                        <th class="text-center">
                            <i class="fas fa-money-bill-wave me-2 text-primary"></i>Method
                        </th>
                                ...
                                <c:choose>
                                    ...
                                    <c:when test="${o.paymentMethod == 'BANKING'}">
                                        ...
                                        <span class="badge bg-info">
                                            <i class="fa-solid fa-building-columns me-1"></i>BANKING
                                        </span>
